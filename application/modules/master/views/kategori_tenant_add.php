...
<div class="box-header"><h3 class="box-title">Form Input Kategori Tenant</h3></div>
<form action="<?php echo base_url();?>master/save_kategori_tenant" method="post" name="frm">

	<div class="box-body">

		<div class="form-group">
			<label>Kategori Tenant</label>
			<input type="text" class="form-control" id="KategoriTenant" name="KategoriTenant" placeholder="Kategori Tenant   .....">
		</div>	
