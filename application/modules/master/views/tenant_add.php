...
<div class="box-header"><h3 class="box-title">Form Input Tenant</h3></div>
<form action="<?php echo base_url();?>master/save_tenant" method="post" name="frm">
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="NamaTenant" name="NamaTenant" placeholder="Nama Tenant   .....">
		</div>	
